...
public class DWBinariesTest {
    ...
    @Test
    void testDWBinaries_fromBase64() {
    ...
    @Test
    void testDWBinaries_readLinesWith() {
    ...
    //TODO additional testing
    @Test
    void testDWBinaries_writeLinesWith() {
